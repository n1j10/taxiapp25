...
class ShowBaghdadMapPage extends StatefulWidget {
  ...
  @override
  State<ShowBaghdadMapPage> createState() => _ShowBaghdadMapPageState();
}

class _ShowBaghdadMapPageState extends State<ShowBaghdadMapPage> {
  String startAddress = '';
  String endAddress = '';
